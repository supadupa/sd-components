/**
 * ATTENTION THIS IS A MODIFIED VERSION OF INTRO.JS FOR ONBOARDING
 * THERE ARE PARAMETERS OF POSITIONING MODIFIED THAT WOULD NEED TO BE
 * RE-ADDED TO THE NEW VERSION IN CASE OF UPDATE
*/
  ...
  */
  ...
  function _placeTooltip(targetElement, tooltipLayer, arrowLayer) {
    ...
    switch (currentTooltipPosition) {
      ...
      case 'left':
        ...
        tooltipLayer.style.right = (_getOffset(targetElement).width + 40) + 'px';
        arrowLayer.className = 'introjs-arrow right';
        break;
      case 'bottom':
      // Bottom going to follow the default behavior
      default:
        tooltipLayer.style.bottom = '-' + (_getOffset(tooltipLayer).height + 30) + 'px';
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer != null) {
      ...
      skipTooltipButton.href = '#main-wrap-slider';
    ...
    if (!_elementInViewport(targetElement.element) && this._options.scrollToElement === true) {
      ...
      if (top < 0 || targetElement.element.clientHeight > winHeight) {
        window.scrollBy(0, top - 500); // 30px padding from edge to look nice

      //Scroll down
      } else {
        window.scrollBy(0, bottom + 200); // 70px + 30px padding from edge to look nice
      }
    }
